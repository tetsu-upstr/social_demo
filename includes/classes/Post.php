...
class Post {
  ...
  public function submitPost($body, $user_to) {
    ...
    if ($check_empty != "") {
      ...
      // get username by User.php getUsername() method
  ...
  public function loadPostsFriends($data, $limit) {
    ...
    if(mysqli_num_rows($data_query) > 0) {
      ...
      while($row = mysqli_fetch_array($data_query)) {
        ...
        //user_toがnoneでなければ投稿にuser_toを付与（例：ミッキー to グーフィー）
        if ($row['user_to'] == "none") {
          $user_to = "";
        } else {
        ...
        if ($user_logged_obj->isFriend($added_by)) {
            ...
            <script>
              ...
              function toggle<?php echo $id; ?>() {
                ...
                if (!target.is("a")) {
                  ...
                  if (element.style.display == "block") // show
            ...
            $start_date = new DateTime($date_time); // 投稿時間
      ...
      <script>
        ...
        $(document).ready(function() {
            ...
            $('#post<?php echo $id; ?>').on('click', function() {
                bootbox.confirm("本当に投稿を削除してよろしいですか？", function(result) {
